...
data_ICPR = np.load('../data/figure5_ICPR.npz')
data_PR = np.load('../data/figure5_PR.npz')
...
t_phi = data_ICPR['t']
phi_sm = data_ICPR['phi_sm']*1000
free_Ca_ICPR = data_ICPR['free_Ca_di']

t = data_ICPR['t'][0::1000]
E_Na_s = data_ICPR['E_Na_s'][0::10000]*1000
E_Na_d = data_ICPR['E_Na_d'][0::100]*1000
E_K_s = data_ICPR['E_K_s'][0::10000]*1000
E_K_d = data_ICPR['E_K_d'][0::100]*1000
E_Cl_s = data_ICPR['E_Cl_s'][0::10000]*1000
E_Cl_d = data_ICPR['E_Cl_d'][0::100]*1000
E_Ca_s = data_ICPR['E_Ca_s'][0::10000]*1000
E_Ca_d = data_ICPR['E_Ca_d'][0::100]*1000
Na_si = data_ICPR['Na_si'][0::1000]
Na_se = data_ICPR['Na_se'][0::1000]
Na_di = data_ICPR['Na_di'][0::1000]
Na_de = data_ICPR['Na_de'][0::1000]
K_si = data_ICPR['K_si'][0::1000]
K_se = data_ICPR['K_se'][0::1000]
K_di = data_ICPR['K_di'][0::1000]
K_de = data_ICPR['K_de'][0::1000]
Cl_si = data_ICPR['Cl_si'][0::1000]
Cl_se = data_ICPR['Cl_se'][0::1000]
Cl_di = data_ICPR['Cl_di'][0::1000]
Cl_de = data_ICPR['Cl_de'][0::1000]
Ca_si = data_ICPR['Ca_si'][0::1000]
Ca_se = data_ICPR['Ca_se'][0::1000]
Ca_di = data_ICPR['Ca_di'][0::1000]
Ca_de = data_ICPR['Ca_de'][0::1000]
...
ax3.set_title('ICPR $\phi\mathrm{_{sm}}$')
ax3.set_yticks([-65, 0])
ax3.set_xlim(10,20)
ax3.set_ylim(-75, 25)
...
### Panel D ###
ax4.plot(t_phi, free_Ca_ICPR*1e6, ls='-', color='k')
ax4.set_title('ICPR $0.01\mathrm{[Ca^{2+}]_{di}}$')
ax4.set_ylabel('nM')
ax4.set_xlim(10,20)
axin4 = inset_axes(ax4, width="40%", height="40%", bbox_to_anchor=(0.0, 0.5, 1., 1.), bbox_transform=ax4.transAxes, loc=3)
axin4.plot(t_phi, free_Ca_ICPR*1e6, ls='-', color='k')
...
### Panel E ###
l1 = ax5.plot(data_ICPR['t'][0::10000], E_Na_s)[0]
l2 = ax5.plot(data_ICPR['t'][0::10000], E_K_s)[0]
l3 = ax5.plot(data_ICPR['t'][0::10000], E_Cl_s)[0]
l4 = ax5.plot(data_ICPR['t'][0::10000], E_Ca_s)[0]
...
### Panel F ###
l1 = ax6.plot(data_ICPR['t'][0::100], E_Na_d)
l2 = ax6.plot(data_ICPR['t'][0::100], E_K_d)
l3 = ax6.plot(data_ICPR['t'][0::100], E_Cl_d)
l4 = ax6.plot(data_ICPR['t'][0::100], E_Ca_d)
