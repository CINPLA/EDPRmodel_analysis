...
### Panel A ###
ax1.plot(t, phi_vc, ':', zorder=10, label='VC')
ax1.plot(t, phi_diff, '-', zorder=10, label='diff')
ax1.plot(t, phi_se, 'k-', zorder=9, label='KNP')
...
ax2.set_xlim([19350,19400])
ax2.set_ylim([-0.25,0.5])
ax2.set_yticks([-0.25, 0, 0.25])
ax2.set_yticklabels([-0.25, 0, 0.25])
...
plt.tight_layout()
plt.savefig('figures_pdf/figure9.pdf', dpi=300)
