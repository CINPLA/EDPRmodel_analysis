...
data_ICPR = np.load('../data/figure6_ICPR.npz')
...
phi_dm = data_ICPR['phi_dm']*1000
E_Na_s = data_ICPR['E_Na_s']*1000
E_Na_d = data_ICPR['E_Na_d']*1000
E_K_s = data_ICPR['E_K_s']*1000
E_K_d = data_ICPR['E_K_d']*1000
E_Cl_s = data_ICPR['E_Cl_s']*1000
E_Cl_d = data_ICPR['E_Cl_d']*1000
E_Ca_s = data_ICPR['E_Ca_s']*1000
E_Ca_d = data_ICPR['E_Ca_d']*1000
Na_si = data_ICPR['Na_si']
Na_se = data_ICPR['Na_se']
Na_di = data_ICPR['Na_di']
Na_de = data_ICPR['Na_de']
K_si = data_ICPR['K_si']
K_se = data_ICPR['K_se']
K_di = data_ICPR['K_di']
K_de = data_ICPR['K_de']
Cl_si = data_ICPR['Cl_si']
Cl_se = data_ICPR['Cl_se']
Cl_di = data_ICPR['Cl_di']
Cl_de = data_ICPR['Cl_de']
Ca_si = data_ICPR['Ca_si']
Ca_se = data_ICPR['Ca_se']
Ca_di = data_ICPR['Ca_di']
Ca_de = data_ICPR['Ca_de']
...
ax3.set_title('ICPR $\phi\mathrm{^{sm}}$')
ax3.set_yticks([-65, 0])
ax3.set_xlim(10,22)
ax3.set_ylim(-75, 25)
...
### Panel D ###
ax4.plot(t, free_Ca_ICPR*1e6, ls='-', color='k')
...
axin4.plot(t, free_Ca_ICPR*1e6, ls='-', color='k')
