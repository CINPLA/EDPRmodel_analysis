...
def calculate_ATP(my_cell, t):
    ...
    j_Ca_dec_s = my_cell.U_Cadec * (my_cell.Ca_si - my_cell.Ca0_si)*my_cell.V_si/my_cell.A_s
    j_Ca_dec_d = my_cell.U_Cadec * (my_cell.Ca_di - my_cell.Ca0_di)*my_cell.V_di/my_cell.A_d
