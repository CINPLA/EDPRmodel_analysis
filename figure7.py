...
from solve_ICPRmodel_without_active_transport import *
from print_final_values import *
from calculate_sigma import *
from calculate_ATP import *
...
sol = solve_ICPRmodel_without_active_transport(t_dur, alpha)
...
ATP = calculate_ATP(my_cell, t)

# save to file
np.savez('data/figure7', t=t, phi_si=phi_si, phi_se=phi_se, phi_di=phi_di, phi_de=phi_de, phi_sm=phi_sm, phi_dm=phi_dm, \
    ...
    sigma_i=sigma_i, sigma_e=sigma_e, ATP=ATP)
